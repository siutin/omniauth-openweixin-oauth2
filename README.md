...
```ruby
gem "omniauth-openweixin-oauth2", git: 'git@github.com:siutin/omniauth-openweixin-oauth2.git'
```
...
Rails.application.config.middleware.use OmniAuth::Builder do
  provider :open_weixin, ENV["WECHAT_APP_ID"], ENV["WECHAT_APP_SECRET"]
end
```
...
siutin, Click [here](https://github.com/siutin/omniauth-openweixin-oauth2)
